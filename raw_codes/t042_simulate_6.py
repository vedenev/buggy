...
def get_target_direction(last_x, last_y, vx, vy):
    ...
    condition = 0 <= last_x_pixels
    condition = condition and last_x_pixels <= vx.shape[1] - 1
    condition = condition and 0 <= last_y_pixels
    condition = condition and last_y_pixels <= vx.shape[0] - 1
    if condition:
