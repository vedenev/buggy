...
if x_detected_all.size >= 2: # must be at least two codes
    ...
    # grid search:
    #cs1 = np.linspace(xy_initial[0] - 800.0, xy_initial[0] + 800.0, 301)
    #cs2 = np.linspace(xy_initial[1] - 800.0, xy_initial[1] + 800.0, 301)
    #cs3 = np.linspace(angle_initial - np.pi / 4, angle_initial + np.pi / 4, 101)
    #
    #loss_min = -0.9967956
    #solution_min = [[ 284.       ]
    # [1502.1106   ]
    # [  -1.6032898]]
    #dot_products_tmp2_min  = [[0.9972041]
    # [0.9986704]
    # [0.9967956]
    # [0.9969983]]
    #
    ...
    # [1507.444    ]
    # [  -1.6032898]]
    #dot_products_tmp2_min  = [[0.99717665]
    # [0.99870247]
    # [0.9969153 ]
    # [0.99688995]]
    #cs1 = np.linspace(284 - 50.0, 284 + 50.0, 101)
    #cs2 = np.linspace(1507 - 50.0, 1507 + 50.0, 101)
    #cs3 = np.linspace(-1.6032898 - np.pi / 12, -1.6032898 + np.pi / 12, 51)
    #
    #loss_min = -0.99694806
    #solution_min = [[ 334.       ]
    # [1487.       ]
    # [  -1.6347058]]
    #dot_products_tmp2_min  = [[0.9971374 ]
    # [0.99864393]
    # [0.9969539 ]
    # [0.99694806]]
    #
    cs1 = np.linspace(284 - 70.0, 284 + 70.0, 201)
    cs2 = np.linspace(1507 - 50.0, 1507 + 50.0, 201)
    cs3 = np.linspace(-1.6032898 - np.pi / 12, -1.6032898 + np.pi / 12, 101)
    #
    #loss_min = -0.9969708
    #solution_min = [[ 352.6      ]
    # [1483.5      ]
    # [  -1.6451777]]
    #dot_products_tmp2_min  = [[0.9969965]
    # [0.9987188]
    # [0.9969754]
    # [0.9969708]]
    #
