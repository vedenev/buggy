...
if RECALCULATE:
    ...
    #for step_index in range(27, 27 + 1):
        ...
        is_localized, current_solution, current_solution_iterations, right_side_iterations, code_detected_all = localize(x_detected_all, y_detected_all, code_detected_all, code_size_all, x_detected_pairs_all, y_detected_pairs_all)
...
for step_index in range(len(for_localization)):
    ...
    right_side_iterations = right_side_iterations_all[step_index]
    ar_s = 300.0
