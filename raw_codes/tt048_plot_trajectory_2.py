...
ratio_is_localized = np.where(is_localized_all)[0].size / is_localized_all.size
print('ratio_is_localized =', ratio_is_localized) # 0.4961832061068702
...
print(n_correct / n_all) # 0.972891566265060, 0.9829545454545454
...
plt.figure()
plt.plot(is_localized_angle_all)
