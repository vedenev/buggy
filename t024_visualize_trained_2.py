# -*- coding: utf-8 -*-
"""
Created on Tue May 12 12:10:10 2020
...
X_MIN_BASE_PATH = './x_min_m_0_7037_2020_05_11__19_30/x_min.npy'
...
x = np.load('./x_min_m_0_7037_2020_05_11__19_30/x_min.npy')
...
for train_val_index in range(2):
    ...
    for file_index in range(len(files)):
            ...
            for point_count_2 in range(point_count_1 + 1, points.shape[0]):
                ...
                valid_points[point_count_1] and valid_points[point_count_2]:
                    ...
                    if signal_strengh > SIGNAL_STRENGTH_THRESHOLD and check_ok:
                        ...
                        cv2.putText(frame_copy, str(code), (int(point_middle_tmp[0]), int(point_middle_tmp[1])), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 255), 2)
                        #print('code =', code)
        ...
        cv2.imwrite(DIR_OUT + '/' + str(train_val_index) + '_' + file_tmp + '.png', frame_copy)
    
    time_2 = time.time()                    
    time_mean = (time_2 - time_1) / len(files)
...
# before add visualization:

#tp_all = 23
#fp_all = 0
#fn_all = 4
#n_boxes_all = 27
#time_mean = 0.07338881492614746
# 
#tp_all = 8
#fp_all = 0
#fn_all = 1
#n_boxes_all = 9
#time_mean = 0.07200413942337036
