...
field_negative_increased = cv2.dilate(field_negative, kernel, iterations=15)
...
vx_path = -cv2.Sobel(map_distance, cv2.CV_32F, 1, 0, ksize=3)
vy_path = -cv2.Sobel(map_distance, cv2.CV_32F, 0, 1, ksize=3)
